...
@section('content')
<h3 class="page-heading mb-4">Nuevo Exámen </h3>
          <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
    ...
    {!! Form::open(['url' => 'examen', 'class' => 'form-horizontal', 'id'=>'frmItem']) !!}
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-3">
                    ...
                    <a href="{{ url('examen') }}" class="btn btn-info mr-2">Cancelar</a>
                </div>
            </div>
    {!! Form::close() !!}
    </div>
       ...
       $('#frmItem').formValidation({
        ...
        .each(function() {
            ...
            toolbar: [
                    ...
                    { name: 'paragraph', items: [ 'NumberedList', 'BulletedList', '-', 'Outdent', 'Indent', 'align' ] },
                ...
                .editor
                    .on('change', function(e) {removeButtons: ''
